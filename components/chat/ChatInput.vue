    ...
    <form @submit.prevent="handleSubmit" class="flex gap-2">
      <div class="flex-1 relative">
        <textarea
          ...
          class="w-full resize-none rounded-lg border border-gray-100 p-3 pr-24 focus:outline-none focus:ring-2 focus:ring-indigo-200 min-h-[44px] max-h-[200px]"
          :rows="1"
        ...
        <div class="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2">
          ...
          <button
            type="submit"
            class="text-indigo-600 hover:text-indigo-700 transition-colors p-1 rounded-full hover:bg-indigo-50 disabled:opacity-50 disabled:cursor-not-allowed"
